...
/*
fprintf(stdout, "Number of Libraries = %d\n", n);
fflush(stderr);
*/
...
*/
          ...
          lib_addr = read_nibbles(romptab, 5);
/*
fprintf(stdout, "Library addr = %.5lx\n", lib_addr);
fflush(stderr);
*/
          romptab += 5;
          ...
          if (offset > 0)
            {
              ...
              lib_addr += offset;
/*
fprintf(stdout, "Link table addr = %.5lx\n", lib_addr);
fflush(stderr);
*/
	      /*
	       * check if library is in ROM
...
/*
fprintf(stdout, "Link table addr (2) = %.5lx\n", lib_addr);
fflush(stderr);
*/
              /*
              ...
              link_end += lib_addr;
/*
fprintf(stdout, "Link table end = %.5lx\n", link_end);
fflush(stderr);
*/
              /*
